#ifndef _GESTURE_SENSOR_
#define _GESTURE_SENSOR_
...
#define GESTURE_VALUE_ARRAY_SIZE_MAX	32
struct gesture_data_t
{
	struct gesture_value_t 	value_array[GESTURE_VALUE_ARRAY_SIZE_MAX];
	uint8_t					array_size;
	int16_t 				ud_delta;
    int16_t 				lr_delta;
    int16_t 				ud_count;
